...
// the Mesh namespace in detection.cpp. This is the part that holds state, and
// the part the screens talk to.
//
...
// What the scan response should carry right now, or nullptr. `gen` changes
// exactly when the answer does, so the radio touches the stack only then.
